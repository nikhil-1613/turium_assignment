...
//         data.map((s) => ({
//           ...s,
//           updatedAt: new Date(), // override for display
//           history: [
//             {
//               type: "Created",
...
// //refreshing the services automatically
// useEffect(() => {
//   const interval = setInterval(() => {
//     fetch("/api/services")
//       .then((res) => res.json())
...
//               {
//                 type: "Auto-refreshed",
//                 description: "Latest state from server",
//                 timestamp: new Date(),
//               },
//             ],
//           }))
//         )
//       )
//       .then(() => toast.success("Services refreshed"))
//       .catch(() => toast.error("Refresh failed"));
//   }, 30000);
//   return () => clearInterval(interval);
// }, []);
...
//     // Always sort updatedAt in descending by default
//     const isDateSort = sortKey === 'updatedAt';
//     if (vA < vB) return isDateSort ? 1 : sortAsc ? -1 : 1;
//     if (vA > vB) return isDateSort ? -1 : sortAsc ? 1 : -1;
//     return 0;
//   });
// };
...
//   const baseHistory = editService?.history || [];
//   const updateEntry = formData.updateDesc
//     ? {
//         type: "Update",
//         description: formData.updateDesc,
...
//   const newHistory = editService
//     ? [...baseHistory, ...(updateEntry ? [updateEntry] : [])]
//     : [
//         {
//           type: "Created",
//           description: "Service created",
...
//         setServices((prev) =>
//           prev.map((s) =>
//             s.id === editService.id ? { ...updatedService, id: s.id } : s
//           )
//         );
...
//       .then((res) => res.json())
//       .then((data) => {
//         setServices((prev) => [...prev, { ...data.service, updatedAt: new Date(), history: newHistory }]);
...
//                     </div>
//                     <p className="text-sm text-gray-600 dark:text-gray-300">
//                       Last updated: {s.updatedAt.toLocaleTimeString()}
//                     </p>
//                     {/* Move the icons inside the card */}
//                     <div className="flex justify-end mt-4 gap-4">
//                       <FiEdit2
//                         onClick={(e) => {
//                           e.stopPropagation();
...
//     if (editService) {
//       setServices((prev) =>
//         prev.map((s) => (s.name === editService.name ? newService : s))
//       );
//       toast.success("Service updated");
//     } else {
